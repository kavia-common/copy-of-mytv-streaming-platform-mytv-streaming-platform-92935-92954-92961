    ...
    <section className="relative my-8">
      <div className="mx-4 sm:mx-5 md:mx-6 lg:mx-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
          <button
            ...
            className="rounded-full bg-white/10 p-2 text-white hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-amber-400"
          >
            ‹
          </button>
          <button
      ...
      <div className="group relative">
        ...
        <button
          ...
          aria-label={`${title} previous`}
          onClick={() => scrollBy(-600)}
          className="hidden md:flex absolute left-2 top-1/2 -translate-y-1/2 z-10 h-10 w-10 items-center justify-center rounded-full bg-black/40 text-white ring-1 ring-white/10 hover:bg-black/60 focus:outline-none focus:ring-2 focus:ring-amber-400 opacity-0 group-hover:opacity-100 transition-opacity"
        >
          ‹
        </button>
        <button
          ...
          aria-label={`${title} next`}
          onClick={() => scrollBy(600)}
          className="hidden md:flex absolute right-2 top-1/2 -translate-y-1/2 z-10 h-10 w-10 items-center justify-center rounded-full bg-black/40 text-white ring-1 ring-white/10 hover:bg-black/60 focus:outline-none focus:ring-2 focus:ring-amber-400 opacity-0 group-hover:opacity-100 transition-opacity"
        >
          ›
        </button>
